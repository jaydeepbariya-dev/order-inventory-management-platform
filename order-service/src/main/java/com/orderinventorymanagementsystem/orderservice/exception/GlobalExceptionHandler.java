...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorInfo> handleOrderNotFound(
    ...
    public ResponseEntity<ErrorInfo> handleUnauthorizedAccess(
    ...
    public ResponseEntity<ErrorInfo> handleInsufficientInventory(
    ...
    public ResponseEntity<ErrorInfo> handlePaymentProcessing(
    ...
    public ResponseEntity<ErrorInfo> handleInvalidOrderRequest(
